...
// PowerPoint exports (confirmed manually — no CSV, no API). There is no
// automatable feed for this data, so the Avian Influenza dashboard section
// links to this page directly instead of fetching anything.
