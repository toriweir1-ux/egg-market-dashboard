...
// USDA APHIS's HPAI Commercial & Backyard Flocks page itself only offers
// PDF/PowerPoint exports — no CSV, no documented API. But that page embeds
// a public Tableau Server dashboard, and Tableau Server exposes a plain
// data export by appending ".csv" to a public view's URL. Confirmed working
// directly against this exact URL: one row per confirmed detection, with
// date/flock-type/state/birds-affected columns.
...
// The human-readable APHIS page this dashboard is embedded in — used as the
// citation link on the Avian Influenza chart.
